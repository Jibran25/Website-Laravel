...
<head>
    ...
    <style>
        .tm-services-bg { background-image: url(public/img/new-vision-03.jpg); }
    </style>
    <!--
        ...
        <main>
                ...
                <div class="row tm-welcome-row tm-services">
                    <div class="col-md-3 col-sm-6">
                        <figure class="tm-services-img">
                            <img src="public/img/services-1.jpg" alt="Image" class="img-fluid">        
                            <figcaption class="tm-service-description">Business Strategy</figcaption>
                        </figure>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <figure class="tm-services-img">
                            <img src="public/img/services-2.jpg" alt="Image" class="img-fluid">        
                            <figcaption class="tm-service-description">Digital Marketing</figcaption>
                        </figure>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <figure class="tm-services-img">
                            <img src="public/img/services-3.jpg" alt="Image" class="img-fluid">    
                            <figcaption class="tm-service-description">Social Platforms</figcaption>
                        </figure>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <figure class="tm-services-img">
                            <img src="public/img/services-4.jpg" alt="Image" class="img-fluid">    
            ...
            <section class="tm-featured">
                ...
                <div class="tm-partners mx-auto">
                    <div>
                        <img src="public/img/partner-01.png" alt="Partner Image" class="img-fluid">
                        <img src="public/img/partner-02.png" alt="Partner Image" class="img-fluid">
                        <img src="public/img/partner-03.png" alt="Partner Image" class="img-fluid">
                        <img src="public/img/partner-04.png" alt="Partner Image" class="img-fluid">
                        <img src="public/img/partner-05.png" alt="Partner Image" class="img-fluid">    
                    </div>
