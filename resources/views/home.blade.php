...
<head>
    ...
    <link href="public/theme/slick/slick-theme.css" rel="stylesheet" />
	<link href="public/theme/css/bootstrap.min.css" rel="stylesheet" /> <!-- https://getbootstrap.com -->
	<link href="public/theme/css/templatemo-new-vision.css" rel="stylesheet" />
    <style>
        .tm-main-bg {
...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <div class="tm-main-bg">
                    {{-- <img src="public/img/new-vision-01.jpg" alt=""> --}}
                </div>        
            </div>
        </div>
            ...
            <section class="tm-welcome">
                ...
                <div class="row tm-welcome-row">
                    <article class="col-lg-6 tm-media">
                        <img src="public/img/img-3x2-01.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="public/img/img-3x2-02.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="public/img/img-3x2-03.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="public/img/img-3x2-04.jpg" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
            ...
            <section class="tm-featured">
                ...
                <div class="grid tm-carousel">
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-01.jpg" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Template</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-02.jpg" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Top</span> CSS Theme</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-03.jpg" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Template</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-04.jpg" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Great</span> Web Theme</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-05.jpg" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Collection</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-06.jpg" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Max</span> CSS Layout</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-07.jpg" alt="Featured Item">
                        <figcaption>
                            <h4><i><span>Best</span> HTML Layout</i></h4>
                        </figcaption>
                    </figure>
                    <figure class="effect-honey">
                        <img src="public/img/gallery-item-08.jpg" alt="Featured Item">
                        <figcaption>
    ...
    <script src="public/theme/js/jquery-3.4.1.min.js"></script>
    <script src="public/theme/slick/slick.min.js"></script>
    <script src="public/theme/js/bootstrap.min.js"></script>
    <script src="public/theme/js/templatemo-script.js"></script>
</body>
</html>